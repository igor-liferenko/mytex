all:
	...
	@cp rstex.cpp.pre .build/ # ctie
	@./mkpool TEX_STRING .build/rstex.cpp.pre .build/rstex.h.pre
	@g++ -o initex -O3 -std=c++14 -Wno-unused-result -Wno-dangling-else .build/rstex.cpp -DNO_DEBUG
	@g++ -o virtex -O3 -std=c++14 -Wno-unused-result -Wno-dangling-else .build/rstex.cpp -DNO_DEBUG -DNO_INIT
